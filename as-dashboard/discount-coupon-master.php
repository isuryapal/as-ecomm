...
?>
							<tr>
								...
								<td>
									...
									<a class="" href="<?php echo $deleteURL; ?>?page=<?php echo $pageNo;?>&id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?');" title="Click to delete this row, this action cannot be undone."><i class="icon-remove3"></i></a>
								</td>
							</tr>
<?php
						}
