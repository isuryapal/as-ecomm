...
class MyPDF extends TCPDF {
    public function _footer($input) {
		...
		// $this->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '', $input, $border = 0, $ln = 0, $fill = 0, $reseth = true, $align = '', $autopadding = true);
		
		  $this->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '', $input, $border = 0, $ln = 1, $fill = 0, $reseth = true, $align = 'top', $autopadding = true);
    }
	
	// public function _footerQuotation($input) {
        // $this->SetY(-35);
        // $this->SetFont('helvetica', 'I', 8);
		// $this->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '', $input, $border = 0, $ln = 0, $fill = 0, $reseth = true, $align = '', $autopadding = true);
	...
	public function _footerChallan($input) {
        $this->SetY(-55);
        $this->SetFont('helvetica', 'I', 8);
		// $this->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '', $input, $border = 0, $ln = 0, $fill = 0, $reseth = true, $align = '', $autopadding = true);
	 ...
	 public function Footer() {
        ...
        // Page number
		$text = '';
		$text = '<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    	<tr>
                            <td align="center" style="padding: text-align:center; 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
							  <h4>THANK YOU FOR YOUR BUSINESS!</h4>
                            </td>
							</tr>
                    </table>';
		
		$this->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '', $text, $border = 0, $ln = 0, $fill = 0, $reseth = true, $align = '', $autopadding = true);
    }
    ...
    // public function setHtmlHeader($htmlHeader) {
			...
			// if ($page == 1){
				...
				// $this->writeHTMLCell(
					// $w = 0, $h = 0, $x = 20, $y = 20,
					// $htmlHeader, $border = 0, $ln = 1, $fill = 0,
    ...
    public function Header() {
		$this->SetY(0);
		$headerText = '';
		$headerText .= '<table cellpadding="0" cellspacing="0">
				<tbody>
					<tr class="top">
						<td colspan="2">
							<table>
								<tbody>
									...
									<tr>
										<td class="title" width="30%">
											<img src="http://192.168.1.113/staging/php/rajputana/re_console/images/logo.png" alt="Logo"   border="0" style="display:block;float:left;"> 
										</td>
										<td width="30%"></td>
										<td width="40%">
											<table cellspacing="0" cellpadding="0" border="0">
												...
												<tr>
													...
													<tr>
														...
														<h3 style="font-family: sans-serif; font-size: 38px; font-weight:bold; line-height: 0px; color: #000000; padding: 0 0px 0px; text-align: right;"><i>Quotation For '.$_SESSION['quoteType'].'</i></h3> 
															<table style="width:100%" style="font-weight:normal;font-size:16px;line-height:30px;">
																<tr>
																	<td align="right">DATE :-</td>
																	<td align="left">&nbsp;'.$_SESSION['currentDate'].'</td>
																</tr>';
								
	if($_SESSION['quoteNo'] != '') {								
		$headerText  .= '<tr>
						 <td align="right">QUOTATION # :-</td>
						 <td align="left">&nbsp;'.$_SESSION['quoteNo'].'</td>
					</tr>';
	}												
	
	$headerText  .= '<tr>
					   <td align="right">CUSTOMER ID :-</td>
					   <td align="left">&nbsp;'.$_SESSION['customerCode'].'</td>
					</tr></table>
												</td>
											</tr>
										</tbody>
		...
		$this->writeHTMLCell(
			$w = 0, $h = 0, $x = 10, $y = 10,
			$headerText, $border = 0, $ln = 1, $fill = 0,
			$reseth = true, $align = 'top', $autopadding = true);
