...
if (!defined('PDF_PAGE_FORMAT')) {
	// define ('PDF_PAGE_FORMAT', 'C0'); // using extra large paper, change to A4 for regular paper
	define ('PDF_PAGE_FORMAT', 'A4'); // using extra large paper, change to A4 for regular paper
}

if (!defined('PDF_PAGE_ORIENTATION')) {
	// define ('PDF_PAGE_ORIENTATION', 'L'); // using landscape paper, P for portrait
	define ('PDF_PAGE_ORIENTATION', 'P'); // using landscape paper, P for portrait
}
