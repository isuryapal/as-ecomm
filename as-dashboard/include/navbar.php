<!-- Navbar -->
	...
	<div class="navbar navbar-inverse" role="navigation">
		<div class="navbar-header"><a class="navbar-brand" href="index.php"><img src="<?php echo LOGO ?>" alt="<?php echo SITE_NAME ?>" title="<?php echo SITE_NAME ?>" width="80"></a><a class="sidebar-toggle"><i class="icon-paragraph-justify2"></i></a>
