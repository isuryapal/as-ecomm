	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			if(empty($about_us) ){
				...
				//update to database
				if(empty($id)){
					$sql = "INSERT INTO ".PREFIX."cms_master(about_us) VALUES ('".$about_us."')";
					//echo $sql; exit;
					$admin->query($sql);
					header("location:".$pageURL."?updatesuccess");
				}else{
					$sql = "UPDATE ".PREFIX."cms_master SET `about_us`='".$about_us."'";
					//echo $sql; exit;
					$admin->query($sql);
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									...
									<textarea name="about_us" rows="7" id="about_us"> <?php  echo $data['about_us']; ?></textarea>
								</div>
