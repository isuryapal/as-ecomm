<?php
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$name = trim($admin->escape_string($admin->strip_all($_POST['category_name'])));
			
			if(empty($name)){
				header("location:".$pageURL."?registerfail&msg=Please enter a name");
				exit();
			}
...
<?php	} ?>
			<form role="form" action="" method="post" id="form" enctype="multipart/form-data">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4">
									<label>Category Name<em style="color:red;">*</em></label>
									<input type="text" class="form-control" required name="category_name" id="1" value="<?php if(isset($_GET['edit'])){ echo $data['category_name']; }?>"/>
									<input type="hidden" name="editedby" value="<?php echo $loggedInUserDetailsArr['id']; ?>">
							...
							<div class="row">
								<?php /* <div class="col-sm-8">
									...
									<div class="input-group">
										<span class="input-group-addon"><?php echo BASE_URL ?>/buy-</span>
										<input type="text" class="form-control" name="permalink" required="required"  value="<?php if(isset($_GET['edit'])){ echo $data['permalink']; }?>" <?php if(isset($_REQUEST['id'])){
											echo "readonly";
										}?>/>
									</div>
									</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-library"></i> Category SEO Details</h6>
					</div>
					<div class="panel-body">
						<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-12"><br>
									...
									<input type="text" class="form-control"  name="meta_keyword" id="1" value="<?php if(isset($_GET['edit'])){ echo $data['meta_keyword']; }?>"/>
								</div>
							</div>
						</div>
