	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			if(empty($term_condition) ){
				header("location:".$pageURL."?updatefail&msg=Please enter about us details");
				exit();
			}
			else {
				//update to database
				if(empty($id)){
					$sql = "INSERT INTO ".PREFIX."cms_master(term_condition) VALUES ('".$term_condition."')";
					//echo $sql; exit;
					$admin->query($sql);
					header("location:".$pageURL."?updatesuccess");
				}else{
					$sql = "UPDATE ".PREFIX."cms_master SET `term_condition`='".$term_condition."'";
					//echo $sql; exit;
					$admin->query($sql);
			...
			<form role="form" action="" method="post" id="form">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-library"></i>Terms and Conditions Details</h6>
					</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									...
									<textarea name="term_condition" rows="7" id="term_condition"> <?php  echo $data['term_condition']; ?></textarea>
								</div>
...
<?php 	include "include/footer.php"; ?>
	...
	<script type="text/javascript">
		var editor = CKEDITOR.replace( 'term_condition', {
