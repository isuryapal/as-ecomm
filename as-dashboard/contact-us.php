	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			if(empty($contact_us) ){
				...
				//update to database
				if(empty($id)){
					$sql = "INSERT INTO ".PREFIX."cms_master(contact_us) VALUES ('".$contact_us."')";
					//echo $sql; exit;
					$admin->query($sql);
					header("location:".$pageURL."?updatesuccess");
				}else{
					$sql = "UPDATE ".PREFIX."cms_master SET `contact_us`='".$contact_us."'";
					//echo $sql; exit;
					$admin->query($sql);
			...
			<form role="form" action="" method="post" id="form">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-library"></i>Contact Us Details</h6>
					</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									...
									<textarea name="about_us" rows="7" id="about_us"> <?php  echo $data['contact_us']; ?></textarea>
								</div>
...
<?php 	include "include/footer.php"; ?>
	...
	<script type="text/javascript">
		var editor = CKEDITOR.replace( 'about_us', {
