<?php
	...
	$pageURL = 'static-banner-master.php';
	$addURL = 'sliderBanner-add.php';
	$deleteURL = 'sliderBanner.php';
	...
	if(isset($_GET['delid']) && !empty($_GET['delid'])){
		...
		$sql="DELETE FROM ".PREFIX."slider_banner WHERE id='".$delid."'";
		$admin->query($sql);
		header('Location:sliderBanner.php?deletesuccess');
	}
...
?>
							<tr>
								...
								?>
								<img src="../images/slider-banner/<?php echo $file_name.'_crop.'.$ext; ?>" style="height: 50px;">
								</td>
