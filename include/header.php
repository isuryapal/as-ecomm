    ...
    <div class="upperhead">
        <div class="container-fluid">
            ...
            <div class="right-side">
                <ul>
                    <li><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+918048006399">+91 8080080406</a></li>
    ...
    <div class="downhead">
        <div class="container-fluid">
            ...
            <form action="<?php echo BASE_URL; ?>/search.php" class="navbar-form navbar-left" method="GET" id="searchFrm">
                ...
                ?>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" >Our Product <i class="fa fa-chevron-down "></i></a>
                    <ul class="dropdown-menu multi-level dropdownmenu1">
                        ...
                        ?>
                        <li class="dropdown-submenu <?php if($functions->num_rows($subCatResult)>0){ echo "haschildren"; } ?>">
                            ...
                            <!-- Product 2 -->
                                ...
                                ?>
                                <li class="dropdown-submenu <?php if($functions->num_rows($subsubCatResult)>0){ echo "haschildren"; } ?>">
                                    <div class="droperarrow"></div>
                                    ...
                                    <!-- Product 3 -->
                                        ...
                                        ?>
                                        <li class="dropdown-submenu <?php if($functions->num_rows($subsubsubCatResult)>0){ echo 'haschildren'; } ?>">
                                            <div class="droperarrow"></div>
                                            ...
                                            <!-- Product 4 -->
                                                ...
                                                ?>
                                                <li class="dropdown-submenu <?php if($functions->num_rows($subsubsubsubCatResult)>0){ echo 'haschildren'; } ?>">
                                                    <div class="droperarrow"></div>
